...
<?php
    ...
    if (!empty($_POST)) {
		...
		$pin = isset($_POST['pinn']) ? $_POST['pinn'] : '';
        ...
        $sql = "UPDATE table_the_iot_projects SET name=?,pin=?, gender=?, email=?, mobile=?, user_date=NOW(), dep=? WHERE id=?";
        $q = $pdo->prepare($sql);
        $q->execute(array($name,$pin, $gender, $email, $mobile, $dep, $id));
        Database::disconnect();
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					...
					<p id="defaultGender" hidden><?php echo $gender;?></p>
				</div>
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="name" type="text"  placeholder="" value="<?php echo $name;?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="email" type="text" placeholder="" value="<?php echo $email;?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="mobile" type="text"  placeholder="" value="<?php echo $mobile;?>" required>
						</div>
					</div>
